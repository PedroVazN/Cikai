  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-50">
      ...
      <div className="bg-white shadow-lg border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
            ...
            <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900 text-center sm:text-left">Gerenciar Leads</h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-12">
        {/* Filtro */}
        <div className="bg-white p-4 sm:p-6 rounded-xl sm:rounded-2xl shadow-lg mb-6 sm:mb-8 border border-gray-100">
        ...
        {loading ? (
          ...
          <>
            ...
            <div className="lg:hidden space-y-4">
              {leads.map((lead) => (
                <div key={lead._id} className="bg-white rounded-xl shadow-lg border border-gray-100 p-4 sm:p-6">
                  <div className="space-y-3">
                    <div>
                      <h3 className="text-lg font-bold text-gray-900 mb-1">{lead.nome}</h3>
                      <a
                        href={`https://wa.me/${lead.telefone.replace(/\D/g, '')}`}
                        target="_blank"
                        rel="noopener noreferrer"
                    ...
                    <div>
                      <p className="text-xs text-gray-500 mb-1">Empreendimento:</p>
                    ...
                    {lead.mensagem && (
                      <div>
                        ...
                        <p className="text-sm text-gray-700">{lead.mensagem}</p>
                      </div>
                    )}
                  </div>
                </div>
