...
function Home() {
  ...
  return (
    <div className="overflow-hidden">
      {/* Hero Section */}
      <section className="relative pt-24 md:pt-28 pb-8 md:pb-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-4 items-start lg:items-end min-h-[520px]">
            {/* Coluna esquerda */}
            <div className="space-y-6 text-center md:text-left">
              <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-primary-100 text-primary-700 rounded-full text-xs md:text-sm font-semibold border border-primary-200 mx-auto md:mx-0">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold leading-tight text-gray-900">
                Venda de imóveis
                <span className="block mt-1 text-gradient">com atendimento premium</span>
              </h1>

              <p className="text-base md:text-lg text-gray-700 leading-relaxed max-w-xl font-medium mx-auto md:mx-0">
                A Corretora C.Ikai é especialista na venda de apartamentos em São Paulo e região do ABC.
                A C.Ikai oferece uma consultoria completa para você comprar com segurança, transparência e as melhores condições do mercado.
              </p>

              <div className="flex flex-col sm:flex-row gap-3 justify-center md:justify-start">
                <a href="#imoveis" className="btn-primary shadow-lg shadow-primary-500/35 hover:shadow-xl hover:shadow-primary-500/45">
                  Ver Imóveis
                </a>
                <a
              ...
              <div className="grid grid-cols-3 gap-3 pt-2">
                <div className="glass-panel p-4 text-center">
                  ...
                  <p className="text-sm text-gray-700 font-semibold">Clientes atendidos</p>
                </div>
                <div className="glass-panel p-4 text-center">
                  <p className="text-2xl md:text-3xl font-extrabold text-gray-900">30+</p>
                  <p className="text-sm text-gray-700 font-semibold">Famílias atendidas</p>
                </div>
                <div className="glass-panel p-4 text-center">
                  <p className="text-2xl md:text-3xl font-extrabold text-gray-900">5+</p>
                  <p className="text-sm text-gray-700 font-semibold">Anos de experiência</p>
                </div>
              </div>

              <div className="flex flex-wrap gap-2.5 pt-1 justify-center md:justify-start">
                <span className="px-3 py-1.5 rounded-full bg-primary-50 text-primary-700 text-xs md:text-sm font-semibold border border-primary-100">
                  Atendimento em São Paulo e ABC
                </span>
                <span className="px-3 py-1.5 rounded-full bg-primary-50 text-primary-700 text-xs md:text-sm font-semibold border border-primary-100">
                  Especialista em imóveis de revenda
                </span>
                <span className="px-3 py-1.5 rounded-full bg-primary-50 text-primary-700 text-xs md:text-sm font-semibold border border-primary-100">
            ...
            {/* Coluna direita */}
            <div className="hidden md:flex relative justify-center lg:justify-end lg:self-end lg:translate-x-20 lg:-mb-10">
              <div className="absolute -z-10 w-[90%] h-[90%] max-w-[560px] rounded-full bg-gradient-to-br from-primary-100 via-white to-fuchsia-50 blur-xl opacity-80"></div>
              <img
                src={predioImage}
                alt="Prédio moderno para revenda"
                className="w-full max-w-[620px] lg:max-w-[760px] max-h-[640px] object-contain drop-shadow-[0_32px_38px_rgba(15,23,42,0.24)]"
              />
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-6">
              ...
              <p className="text-lg text-gray-600 leading-relaxed">
                A Corretora C.Ikai realiza uma pesquisa detalhada do imóvel que atenda às suas necessidades dentro da sua realidade financeira.
                A C.Ikai já ajudou <strong className="text-primary-700">mais de 100 clientes</strong> e{' '}
