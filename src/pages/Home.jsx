...
function Home() {
  ...
  return (
    <div className="overflow-hidden">
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div className="text-center lg:text-left space-y-8">
              ...
              <p className="text-xl md:text-2xl text-gray-600 leading-relaxed max-w-xl mx-auto lg:mx-0">
                No apartamento dos seus sonhos, nas melhores regiões de <span className="font-bold text-gray-800">São Paulo e ABC</span>
              </p>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center gap-3 pt-4">
                <div className="flex items-center gap-2 px-4 py-2 bg-gray-100 rounded-lg">
                  ...
                  <span className="text-sm font-semibold text-gray-700">São Paulo e ABC</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 md:py-32 bg-gradient-to-b from-white via-gray-50/30 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mt-12">
            <Link 
              to="/lancamentos" 
              className="inline-flex items-center gap-2 px-8 py-4 bg-white border-2 border-gray-300 text-gray-700 rounded-xl font-semibold text-lg hover:border-gray-400 hover:bg-gray-50 transition-all duration-300"
            >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={index} className="group p-8 bg-gradient-to-br from-white to-gray-50/50 rounded-2xl border border-gray-100 hover:border-gray-300 hover:shadow-xl transition-all duration-300">
                <div className="w-16 h-16 bg-gray-800 rounded-xl flex items-center justify-center text-white mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg shadow-gray-900/20">
                  {item.icon}
                </div>
      ...
      {/* CTA Final */}
      <section className="py-20 md:py-32 bg-gradient-to-br from-gray-800 via-gray-900 to-gray-950 text-white relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-3 px-8 py-4 bg-white text-gray-800 rounded-xl font-bold text-lg shadow-2xl hover:shadow-3xl hover:scale-105 transition-all duration-300"
          >
