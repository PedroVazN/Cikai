        ...
        <div className="relative h-full flex items-center">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
            <div className="max-w-3xl mx-auto md:mx-0 text-center md:text-left">
              <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold mb-6 sm:mb-8 leading-[1.1] tracking-tight text-white drop-shadow-2xl">
                Parcelas Menores que o
                <span className="block mt-2 sm:mt-3 text-accent-300">Seu Aluguel</span>
              </h1>
              <p className="text-xl sm:text-2xl md:text-3xl lg:text-4xl mb-4 sm:mb-5 text-white font-medium leading-tight drop-shadow-lg">
                No apartamento dos seus sonhos
              </p>
              <p className="text-base sm:text-lg md:text-xl lg:text-2xl mb-8 sm:mb-10 text-white/95 leading-relaxed font-medium px-2 sm:px-0">
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-5 justify-center md:justify-start">
                <Link 
                  to="/lancamentos" 
                  className="btn-luxury text-base sm:text-lg px-8 sm:px-12 py-4 sm:py-5 inline-block text-center w-full sm:w-auto"
                >
                  Ver Lançamentos Agora →
                </Link>
              </div>
              <div className="mt-8 sm:mt-10 flex flex-col sm:flex-row flex-wrap gap-3 sm:gap-4 items-center justify-center md:justify-start">
                <span className="flex items-center gap-2 text-white/90 text-sm sm:text-base bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full border border-white/20">
                  <svg className="w-4 h-4 sm:w-5 sm:h-5 text-accent-300 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  <span className="whitespace-nowrap">Mais de 500 clientes atendidos</span>
                </span>
                <span className="flex items-center gap-2 text-white/90 text-sm sm:text-base bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full border border-white/20">
                  <svg className="w-4 h-4 sm:w-5 sm:h-5 text-accent-300 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  <span className="whitespace-nowrap">50+ famílias ajudadas</span>
                </span>
                <span className="flex items-center gap-2 text-white/90 text-sm sm:text-base bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full border border-white/20">
                  <svg className="w-4 h-4 sm:w-5 sm:h-5 text-accent-300 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  <span className="whitespace-nowrap">5+ anos de experiência</span>
                </span>
              </div>
            </div>
          </div>
