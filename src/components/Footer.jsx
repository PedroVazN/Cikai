        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link to="/lancamentos" className="text-gray-300 hover:text-white transition-colors">
                  Lançamentos
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <p className="text-gray-300 mb-2">Estamos prontos para ajudar você a encontrar o imóvel perfeito.</p>
            <p className="text-gray-400 text-sm mb-4">{getWhatsAppNumber()}</p>
            <a
              href={generateWhatsAppLink(generateContatoMessage())}
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center bg-gray-800 text-white px-6 py-3 rounded-lg font-medium hover:bg-gray-700 transition-colors duration-200"
            >
